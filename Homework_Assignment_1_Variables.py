...
Title = "Best Song in ther World!"

# This is the Best ever song in the whole World
print(f"{Title.center(50, '#')}")
print(f"The best song in the whole World is \"{Song}\"")
print(f"It\'s a {Genre} music from {Artist}")
print(f"You can find the Lyrics at {Lyrics}")
print(f"Or watch at {Youtube}, its only {DurationInMinutes} long")
